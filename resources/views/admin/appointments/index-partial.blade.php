<div data-page-title="Lịch hẹn">
    @php
        ...
        $hasFilters = collect(['q', 'status', 'doctor_id', 'service_id', 'from', 'to'])->contains(fn ($key) => filled(request($key)));
    @endphp
        ...
        <div class="card-body">
            <div class="summary-strip">
                <div class="summary-pill">
                    ...
                    <span class="note">Tất cả kết quả theo bộ lọc hiện tại.</span>
                </div>
                ...
                <div class="col-md-12 d-flex justify-content-end gap-2">
                    @if($hasFilters)
                        <a
                            ...
                            class="btn btn-ghost"
                        >
                            <i class="bi bi-x-circle"></i><span class="d-none d-sm-inline ms-1">Bỏ lọc</span>
                        </a>
                    @endif
            ...
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                                    ...
                                    <form method="post" action="{{ route('admin.appointments.update', $a->id) }}" class="inline-editor">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12 d-flex justify-content-end gap-2">
                                                <button type="button" class="btn btn-ghost" data-bs-toggle="collapse" data-bs-target="#edit-{{ $a->id }}">
                                                    <i class="bi bi-x-lg"></i><span class="d-none d-sm-inline ms-1">Đóng</span>
                                                </button>
                        ...
                        @empty
                            <tr>
                                <td colspan="10" class="text-center text-muted py-5">Không có lịch hẹn phù hợp.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
