...
<section class="py-5 bg-light">
  <div class="container">
    <div class="text-center mb-5" data-aos="fade-up">
      ...
      <p class="text-muted">Khám phá cơ sở vật chất và kết quả điều trị của chúng tôi</p>
    </div>
    <div class="row g-3">
      @foreach($galleryImages->take(6) as $idx => $image)
      <div class="col-6 col-md-4" data-aos="zoom-in" data-aos-delay="{{ $idx*50 }}">
    ...
    <div class="text-center mt-4" data-aos="fade-up">
      <a href="{{ url('/gallery') }}" class="btn btn-outline-primary">
        <i class="bi bi-images me-2"></i>Xem toàn bộ thư viện
      </a>
    </div>
  </div>
</section>
